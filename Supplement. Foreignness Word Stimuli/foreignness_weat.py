...
if __name__ == "__main__": 
  ...
  os.chdir(os.path.join(current_path, 'Supplement. Foreignness Word Stimuli/Attribute Word Stimuli'))
  ...
  os.chdir(os.path.join(current_path, 'Supplement. Foreignness Word Stimuli/Results'))
