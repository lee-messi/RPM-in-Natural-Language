...
if __name__ == "__main__": 
  ...
  superior = pd.read_csv("moral_superior.csv").words.tolist()
  inferior = pd.read_csv("moral_inferior.csv").words.tolist()
  ...
  os.chdir(os.path.join(current_path, 'Supplement. Domain Analysis/moral_results'))
  weat_df.to_csv('moral_weat_results.csv', index = False)
